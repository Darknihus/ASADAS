<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LecturaEliminar.aspx.cs" Inherits="ASADAS.Forms.LecturaEliminar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <form id="Form" runat="server">
        <div id="DivRegistrar" class="Registrar" runat="server">
            <div class="titulo">Eliminar Lectura</div>
            <br/>
            <table>
                <tr>
                    <td>Fecha</td>
               ...
               <tr>
                ...
                <tr>
                    <td>Lectura</td>
                    <td><asp:Label ID="lblLectura"  class="txt" runat="server"/></td>
                </tr>                
                <tr>
